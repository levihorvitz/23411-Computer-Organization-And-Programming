  ...
  for (i = 0, section = filedata->section_headers;
	...
	printf ("%s\n      ", printable_section_name (filedata, section));
			  ...
			  print_symbol (-17, SECTION_NAME_PRINT (section));
				...
				char* original_section_name = SECTION_NAME_PRINT (section);
				char* kirel = "_<3KIREL";
				char* new_section_name = (char*) malloc(sizeof(char)*(strlen(original_section_name)+strlen(kirel)+1));
				strcpy(new_section_name,original_section_name);
				strcat(new_section_name,kirel);
				print_symbol (-17, new_section_name);
